...
func (c *alertServiceClient) Upsert(ctx context.Context, in *Alert, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/alert.AlertService/Upsert", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertServiceClient) Delete(ctx context.Context, in *AssetKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/alert.AlertService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertServiceClient) Get(ctx context.Context, in *AssetKey, opts ...grpc.CallOption) (*Alert, error) {
	out := new(Alert)
	err := c.cc.Invoke(ctx, "/alert.AlertService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertServiceClient) List(ctx context.Context, in *AlertFilter, opts ...grpc.CallOption) (*AlertList, error) {
	out := new(AlertList)
	err := c.cc.Invoke(ctx, "/alert.AlertService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AlertService_Upsert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alert.AlertService/Upsert",
	}
...
func _AlertService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alert.AlertService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AlertService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alert.AlertService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AlertService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alert.AlertService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
