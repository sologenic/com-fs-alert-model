...
exports.MetaData = exports.networkToJSON = exports.networkFromJSON = exports.Network = exports.protobufPackage = void 0;
/* eslint-disable */
const minimal_1 = __importDefault(require("protobufjs/minimal"));
const timestamp_1 = require("../../../../google/protobuf/timestamp");
exports.protobufPackage = "metadata";
var Network;
(function (Network) {
...
exports.MetaData = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.UpdatedAt !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.UpdatedAt), writer.uint32(18).fork()).ldelim();
        }
